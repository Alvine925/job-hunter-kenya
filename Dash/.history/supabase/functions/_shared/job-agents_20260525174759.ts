...
- company: The name of the actual hiring company/employer (e.g., Safaricom, Sidian Bank, Sidai Africa). NEVER output the job board name (do NOT output LinkedIn, BrighterMonday, MyJobMag, Fuzu, JobwebKenya, Corporate Staffing, or similar) as the company. If the company name is not mentioned at all in the posting, use an empty string.
...
{
  "cover_letter": "~300 words, PLAIN TEXT only — no #, *, ---, or em dashes; section headings as '1. Title' on their own line",
  "email_subject": "subject line",
  "email_body": "5 sentences",
  "${qaRule}": [{"question": "...", "answer": "..."}],
  "key_facts": [{"label": "Full name", "value": "..."}, {"label": "Email", "value": "..."}, {"label": "Phone", "value": "..."}, {"label": "LinkedIn", "value": "..."}, {"label": "Location", "value": "..."}, {"label": "Years of experience", "value": "..."}, {"label": "Notice period", "value": "..."}, {"label": "Salary expectation (KES)", "value": "..."}, {"label": "Earliest start date", "value": "..."}]
    ...
    "You are a Kenyan job-application assistant. Return STRICT JSON only with no extra text before or after.",
  );
}
