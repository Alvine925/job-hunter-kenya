...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    meta: [
      ...
      { title: "Tellus - Premium Job Intelligence" },
      { name: "description", content: "Tellus helps you find, match, and apply for the best career opportunities." },
      { name: "author", content: "Tellus" },
      { property: "og:title", content: "Tellus - Premium Job Intelligence" },
      { property: "og:description", content: "Find and match with the best career opportunities using Tellus." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/logo.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "/logo.png" },
      { name: "twitter:title", content: "Tellus - Premium Job Intelligence" },
      { name: "twitter:description", content: "Find and match with the best career opportunities using Tellus." },
    ],
    links: [
      {
        rel: "icon",
